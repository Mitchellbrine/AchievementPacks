...
public class MitchellbrinePicks {
    ...
    public static void init() {
        ...
        mBrine = new AchievementPack("MBrine's Picks","1.0","https://dl.dropboxusercontent.com/u/133619815/mBrinePicks.txt",new Achievement[]{solla,goldenTicket,rich,yopp,waste,possible});
