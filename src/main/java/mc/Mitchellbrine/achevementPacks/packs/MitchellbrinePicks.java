...
public class MitchellbrinePicks {
    ...
    public static void init() {
        ...
        mBrine = new AchievementPack("MBrine's Picks","1.0","https://raw.githubusercontent.com/Mitchellbrine/AchievementPacks/master/packUpdaters/mBrinePack.txt",new Achievement[]{solla,goldenTicket,rich,yopp,waste,possible});
