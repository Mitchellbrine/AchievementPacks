...
public class MitchellbrinePicks {
    ...
    public static void init() {
        ...
        mBrine = new AchievementPack("MBrine Picks","1.0","https://raw.githubusercontent.com/Mitchellbrine/AchievementPacks/master/packUpdaters/",new Achievement[]{solla,goldenTicket,rich,yopp,waste,possible});
