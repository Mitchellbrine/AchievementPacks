...
public class MitchellbrinePicks {
    ...
    public static void init() {
        ...
        mBrine = new AchievementPack("MBrine's Picks","1.0","https://github.com/Mitchellbrine/AchievementPacks/blob/master/packUpdaters/mBrinePack.txt",new Achievement[]{solla,goldenTicket,rich,yopp,waste,possible});
