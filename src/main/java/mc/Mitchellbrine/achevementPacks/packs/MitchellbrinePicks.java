...
public class MitchellbrinePicks {
    ...
    public static void init() {
        ...
        AchievementPack.registerAchievement(solla);
        AchievementPack.registerAchievement(goldenTicket);
        AchievementPack.registerAchievement(rich);
        AchievementPack.registerAchievement(yopp);
        AchievementPack.registerAchievement(waste);
        AchievementPack.registerAchievement(possible);

        mBrine = new AchievementPack("Mitchellbrine's Picks","1.0","https://dl.dropboxusercontent.com/u/133619815/WeatherCarpetsStable.txt",new Achievement[]{solla,goldenTicket,rich,yopp,waste,possible});
