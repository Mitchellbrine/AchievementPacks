...
public class TestPack {
    ...
    public static void init() {
        ...
        test = new AchievementPack("Getting Started","1.0","https://dl.dropboxusercontent.com/u/133619815/WeatherCarpetsStable.txt",new Achievement[]{pickupIronIngot,wood,stone,pig});
