...
public class TestPack {
    ...
    public static void init() {
        ...
        test = new AchievementPack("Getting Started","1.0","https://raw.githubusercontent.com/Mitchellbrine/AchievementPacks/master/packUpdaters/gettingStarted.txt",new Achievement[]{pickupIronIngot,wood,stone,pig});
