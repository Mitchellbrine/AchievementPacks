...
public class TestPack {
    ...
    public static void init() {
        ...
        test = new AchievementPack("Getting Started","1.0","https://github.com/Mitchellbrine/AchievementPacks/blob/master/version.properties",new Achievement[]{pickupIronIngot,wood,stone,pig});
